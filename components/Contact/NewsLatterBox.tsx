  ...
  return (
    ...
    >
      ...
      <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
        Receive timely updates, industry insights, and exciting news directly to
        your inbox. Be the first to know about our latest projects, innovative
        solutions, and trends shaping the digital landscape.
      </p>
      <div>
        <input
          type="text"
        ...
        <p className="text-center text-base leading-relaxed text-body-color dark:text-body-color-dark">
          Stay informed about our latest projects and success stories.
        </p>
      </div>
