...
const OurValueCard: React.FC<OurValueCardProps> = ({
  ...
  return (
    <div className="dark:bg-darker container mx-auto my-8 rounded-2xl bg-customSecondary py-2">
      <div className="grid grid-cols-1 gap-0 md:grid-cols-2 md:gap-8">
        <div className="dark:bg-darker bg-customSecondary p-10">
        ...
        <div className="relative bg-customSecondary dark:bg-[#0d0c1a]">
