...
const featuresData: Feature[] = [
  {
    ...
    title: "Elevating Brands through Innovative Website Design",
    paragraph:
      "Discover the art of exceptional website design at PrimeReserved, where we seamlessly blend creativity and functionality. Our websites are meticulously crafted to provide a visually stunning and immersive user experience, featuring intuitive navigation and responsive design.",
  },
  {
    id: 1,
    icon: (
    ...
    title: "Cutting-edge Solutions in Web Application Development",
    paragraph:
      "Specializing in developing cutting-edge web applications, we harness the latest technologies to deliver robust, scalable, and future-ready solutions. Our commitment is to provide innovative and tailored digital experiences through custom applications.",
  },
  {
    id: 1,
    icon: (
    ...
    paragraph:
      "Embark on a transformative journey with PrimeReserved's web development training. Designed for individuals and teams, our comprehensive programs cover fundamental languages to advanced frameworks. Gain practical skills, confidence, and stay at the forefront of the dynamic web development landscape.",
  },
];
