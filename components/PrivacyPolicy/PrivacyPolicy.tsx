  ...
  return (
    <div className="p-4">
      ...
      <p className="mb-2 dark:text-customDarkTextColor">
        Privacy Policy At PrimeReserved, accessible from www.primereserved.live,
        one of our main priorities is the privacy of our visitors. This Privacy
        Policy document contains types of information that is collected and
        recorded by PrimeReserved and how we use it. If you have additional
        ...
        information that they shared and/or collect in PrimeReserved. This
        ...
        hereby consent to our Privacy Policy and agree to its terms. Information
        we collect The personal information that you are asked to provide, and
        the reasons why you are asked to provide it, will be made clear to you
        ...
        you may choose to provide. How we use your information We use the
        information we collect in various ways, including to: Provide, operate,
        and maintain our website Improve, personalize, and expand our website
        ...
        website, and for marketing and promotional purposes Send you emails
      </p>
    </div>
  );
};
