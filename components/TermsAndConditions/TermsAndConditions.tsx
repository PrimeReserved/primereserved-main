...
const TermsAndConditions: React.FC = () => {
  return (
    <div className="p-4">
      ...
      <p className="mb-2 dark:text-customDarkTextColor">
        Terms and Conditions Welcome to PrimeReserved! These terms and
        conditions outline the rules and regulations for the use of our website.
        By accessing this website, we assume you accept these terms and
        conditions in full. Do not continue to use PrimeReserved&apos;s website
        ...
        PrimeReserved. &quot;Party,&quot; &quot;Parties,&quot; or
        ...
        purpose of meeting the Client&apos;s needs in respect of the provision
        of the Company&apos;s stated services/products, in accordance with and
        subject to, prevailing law of the USA. Any use of the above terminology
        ...
        Cookies We employ the use of cookies. By accessing PrimeReserved&apos;s
        website, you agreed to use cookies in agreement with
        PrimeReserved&apos;s Privacy Policy. Most interactive websites use
        ...
        otherwise stated, PrimeReserved and/or its licensors own the
        intellectual property rights for all material on PrimeReserved. All
        intellectual property rights are reserved. You may access this from
        PrimeReserved for your own personal use subjected to restrictions set in
        these terms and conditions. You must not: Republish material from
        PrimeReserved Sell, rent or sub-license material from PrimeReserved
        Reproduce, duplicate or copy material from PrimeReserved Redistribute
        content from PrimeReserved User Comments This Agreement shall begin on
        the date hereof. Certain parts of this website offer the opportunity for
        users to post and exchange opinions, information, material, and data
        &apos;Comments&apos; in areas of the website. PrimeReserved does not
        screen, edit, publish, or review Comments prior to their appearance on
        the website and Comments do not reflect the views or opinions of
        PrimeReserved, its agents, or affiliates. Comments reflect the view and
        opinion of the person who posts such view or opinion. To the extent
        permitted by applicable laws, PrimeReserved shall not be responsible or
        ...
        of and/or appearance of the Comments on this website. PrimeReserved
